System.register("ZBLyBjtsuHdvPG4wiDvV", ["react", "vev"], function (exports) {
  "use strict";
  var Vev = {};
  var global = {};
  return {
  ...
  __export(src_exports, {
    PhotoThreeSixy: () => PhotoThreeSixty_default2,
    ThreeCarousel: () => ThreeCarousel_default2
  });

  // src/PhotoThreeSixty.tsx
  var import_react2 = __toESM(require_react());

  // src/PhotoThreeSixty.scss
  var PhotoThreeSixty_default = {};
  ...
  var button = /* @__PURE__ */ __name(function button2(props) {
  ...
  var React360Viewer = /* @__PURE__ */ function(_Component) {
    ...
    function React360Viewer2() {
      ...
      _this.viewPercentageRef = /* @__PURE__ */ import_react.default.createRef();
      _this.canvas = null;
      _this.ctx = null;
    ...
    __name(React360Viewer2, "React360Viewer");
    _createClass(React360Viewer2, [{
      ...
      value: function render() {
        ...
        }, !this.state.imagesLoaded ? /* @__PURE__ */ import_react.default.createElement("div", {
        ...
        }), this.props.boxShadow ? /* @__PURE__ */ import_react.default.createElement("div", {
          className: "v360-product-box-shadow"
        }) : ""), /* @__PURE__ */ import_react.default.createElement("abbr", {
        ...
        }), this.state.panmode ? /* @__PURE__ */ import_react.default.createElement(button, {
  ...
  function PhotoThreeSixy() {
    return /* @__PURE__ */ React.createElement("div", {
      className: PhotoThreeSixty_default.container
  ...
  (0, import_react2.registerVevComponent)(PhotoThreeSixy, {
    name: "Photo 360",
    props: [
      {
        type: "image",
  ...
  var PhotoThreeSixty_default2 = PhotoThreeSixy;

  // src/ThreeCarousel.scss
  var ThreeCarousel_default = { "carousel": "ZBLyBjtsuHdvPG4wiDvV__my-app_src__carousel", "tileDiv": "ZBLyBjtsuHdvPG4wiDvV__my-app_src__tileDiv", "tileContent": "ZBLyBjtsuHdvPG4wiDvV__my-app_src__tileContent", "overlay": "ZBLyBjtsuHdvPG4wiDvV__my-app_src__overlay", "icon": "ZBLyBjtsuHdvPG4wiDvV__my-app_src__icon", "formItemWrapper": "ZBLyBjtsuHdvPG4wiDvV__my-app_src__formItemWrapper" };

  // src/ThreeCarousel.tsx
  ...
  function ThreeCarousel({ items, tileGap }) {
    ...
    (0, import_react5.useEffect)(() => {
      ...
      function setupCarousel(numImages2, imgWidth) {
        let apothem = imgWidth / (2 * Math.tan(Math.PI / numImages2));
        figure.style.transformOrigin = `50% 50% ${-apothem}px`;
        for (var i = 0; i < numImages2; i++)
          images[i].style.padding = `${gap}px`;
        for (i = 1; i < numImages2; i++) {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ref: carRef,
      className: ThreeCarousel_default.carousel
    }, /* @__PURE__ */ React.createElement("figure", {
      ref: figureRef
    }, items.length > 0 && items.map((item, index) => /* @__PURE__ */ React.createElement("div", {
      className: ThreeCarousel_default.tileDiv
    }, /* @__PURE__ */ React.createElement("div", {
      className: `${ThreeCarousel_default.tileContent} tile`,
      style: { "backgroundImage": "url('" + item.img.url + "')" },
      onClick: () => rotateCarousel(index)
    }, /* @__PURE__ */ React.createElement("div", {
      className: `${ThreeCarousel_default.overlay} overlay`
    }), /* @__PURE__ */ React.createElement("h1", {
      className: "title"
    }, item.title), /* @__PURE__ */ React.createElement("p", {
      className: "description"
    }, item.description))))), /* @__PURE__ */ React.createElement("nav", {
      ref: navRef
    }, /* @__PURE__ */ React.createElement("img", {
      className: `${ThreeCarousel_default.icon} nav`,
      onClick: handlePrev,
      src: left_default
    }), /* @__PURE__ */ React.createElement("img", {
      className: `${ThreeCarousel_default.icon} nav`,
  ...
  (0, import_react3.registerVevComponent)(ThreeCarousel, {
    name: "3D Carousel",
    knobs: {
  ...
  var ThreeCarousel_default2 = ThreeCarousel;
  return __toCommonJS(src_exports);
})();

      exports("ZBLyBjtsuHdvPG4wiDvV_PhotoThreeSixy", packageBuild.PhotoThreeSixy);
exports("ZBLyBjtsuHdvPG4wiDvV_ThreeCarousel", packageBuild.ThreeCarousel);
    },
  };
});
